...
const SUITES = [
  ...
  { name: 'owners',   file: 'tests/owners/run.mjs',       what: '/owners: le cifre da una fonte (owner-offer · ASPI · catalogo · motore canone), ogni stanza accesa ha il suo PDF vero timbrato ESEMPIO, le promesse spente restano spente e si accendono solo col campo scritto, il modulo contro il handler vero' },
  { name: 'ownersui', file: 'tests/owners/ui.mjs',        what: '/owners in un browser vero a 390 e 1440: niente animazioni al load, la pianta si alza solo col gesto e i marcatori combaciano, etichette ≥44px senza sovrapposizioni, CLS, nessuna richiesta esterna, il modulo 200/400/429' },
