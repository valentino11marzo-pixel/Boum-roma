...
const SUITES = [
  ...
  { name: 'smista',   file: 'tests/documents/smista.mjs', what: 'lo Smistatore dalle porte: un docId non archivia due volte e il doppione non paga il modello; uno sconosciuto MAI sotto un immobile; un proprietario solo fra i suoi (letti per id, mai il catalogo libero su lista vuota), una relazione troppo larga degrada e lo dice, e col budget modello e Storage stanno nel tempo che resta' },
  ...
  { name: 'innesto',  file: 'tests/innesto/run.mjs',      what: 'Innesto: il PDF grande transita da Storage, l\'apply VERO crea contratto+rate (e il caso Via Simeto: gambe agganciate dall\'archivio quando il documento non le porta), un salto non è mai muto, mai un proxy verso host estranei' },
