...
const SUITES = [
  ...
  { name: 'scalo',    file: 'tests/scalo/run.mjs',        what: 'LO SCALO lotto 1: la carta d\'imbarco dice la verità (annullata/standby = niente Wallet, codici mai inventati), e gli ARRIVI del board sono derivati dal dato che c\'era già' },
];
