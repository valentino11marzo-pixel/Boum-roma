...
const SUITES = [
  ...
  { name: 'scarica',  file: 'tests/scarica/run.mjs',     what: 'i download: zero funzioni duplicate (il doppione che rigenerava il PDF a ogni click), il PDF salvato si scarica senza rigenerare, boomOpen consegna anche i data: legacy e non mente mai' },
