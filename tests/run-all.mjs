...
const SUITES = [
  ...
  { name: 'pratica',  file: 'tests/pratica/run.mjs',      what: 'Importa pratica: un contratto firmato FUORI entra in gestione senza mai simulare Magic Sign, il secondo caricamento non duplica, due documenti in disaccordo non si scelgono da soli, prima della presa in gestione non nasce nessun arretrato, e «nessuna ricevuta» resta «da verificare» — mai «non pagato»' },
  { name: 'praticaui', file: 'tests/pratica/ui.mjs',       what: 'Importa pratica in un browser vero: il bottone sta nella gestione contratti, ogni valore mostra fonte e pagina, i due valori in disaccordo restano entrambi visibili, e l\'aggancio sul solo nome non è mai pre-selezionato' },
