...
const SUITES = [
  ...
  { name: 'marketing', file: 'tests/marketing/run.mjs',   what: 'Il Creativo: genera da solo, pubblica MAI da solo — listings intatto a runtime e nel sorgente, tetto settimanale che conta anche i falliti, un fallimento non si ritenta, senza chiavi lo dice UNA volta' },
