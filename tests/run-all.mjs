...
const SUITES = [
  ...
  { name: 'innesto',  file: 'tests/innesto/run.mjs',      what: 'Innesto: la lettura è Opus 5 con output strutturato (mai più un JSON «troncato» che non lo era), più file in un giro (inline o in transito da Storage, mai un proxy verso host estranei), rifiuti/HEIC/troppi file detti con il rimedio; l\'apply VERO crea contratto+rate con token di firma e identità delle parti, AGGIORNA chi c\'è già solo per i campi scelti, archivia i documenti letti, e un salto non è mai muto' },
