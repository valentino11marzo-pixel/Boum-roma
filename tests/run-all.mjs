...
const SUITES = [
  ...
  { name: 'og',       file: 'tests/og/run.mjs',           what: 'l\'immagine social esiste DAVVERO: i default di seo-config risolvono a file del repo, e board + apartments-in non citano mai un PNG fantasma (BOOMsocialprofile era un 404 su ogni condivisione)' },
  { name: 'skyline',  file: 'tests/skyline/run.mjs',      what: 'Skyline 2.0: la rilettura notturna non rompe mai uno stile, i fili sono ≤6 coi TUOI posti sempre, la corsia arriva da dispo (closed non si prenota, illeggibile → «Ask us»), Street View e anello d\'oro solo dove il pin è VERO, e senza mappa le case restano sfogliabili' },
  ...
  { name: 'innesto',  file: 'tests/innesto/run.mjs',      what: 'Innesto: il PDF grande transita da Storage (il 413 di piattaforma non esiste più), l\'endpoint non fa mai da proxy verso host estranei, e il transito si cancella a lettura finita' },
