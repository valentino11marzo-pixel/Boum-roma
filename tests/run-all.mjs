...
const SUITES = [
  ...
  { name: 'scalo',    file: 'tests/scalo/run.mjs',        what: 'LO SCALO lotti 1-5: la carta d\'imbarco dice la verità (annullata/standby = niente Wallet, codici solo dal lessico condiviso), il flight status di /viewing sui momenti veri, il check-in di /book (carta MAI sulla pending), l\'idrante del board sulle corsie di marketLane, la rotta in /casa dai fatti del contratto, il timbro, la porta pubblica /api/meteo che non lascia passare un campo non dichiarato, il NOTAM del Segugio (corsie da marketLane, codici dal lessico, mai una sigla inventata) e il Biglietto del Media Studio (corsia SOLO derivata dal catalogo)' },
];
