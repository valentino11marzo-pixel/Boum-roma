...
(function (root) {
  ...
  var STRINGS = {
    it: {
      ...
      // La faccia a tre stanze (Oggi · Case · Archivio), 24/09/2026.
      'tab.oggi': 'Oggi', 'tab.case': 'Case', 'tab.casa': 'Casa', 'tab.archivio': 'Archivio',
      'pulse.next': 'Prossima rata',
      'pulse.end': 'Fine del contratto',
      'pulse.days.one': 'tra un giorno', 'pulse.days.many': 'tra {n} giorni', 'pulse.ended': 'terminato',
      'ring.left.one': 'giorno alla fine', 'ring.left.many': 'giorni alla fine',
      'ring.day': 'Giorno {d} di {total}', 'ring.before': 'Inizia il {date}',
      'house.back': 'Tutte le case', 'house.journey': 'La vita del contratto', 'house.months': 'Canoni, mese per mese',
      'feed.new': 'Novità dall’ultima visita', 'feed.recent': 'Ultimi documenti', 'feed.all': 'Apri l’archivio',
      'arch.all': 'Tutto', 'arch.missing': 'Non ancora in archivio', 'arch.undated': 'Senza data',
      'arch.count.one': 'un documento', 'arch.count.many': '{n} documenti',
      'arch.secure': 'Ogni documento si apre con un link personale che vale 60 secondi: niente allegati in giro, niente link permanenti.',
    },
    en: {
      ...
      'tab.oggi': 'Today', 'tab.case': 'Homes', 'tab.casa': 'Home', 'tab.archivio': 'Archive',
      'pulse.next': 'Next payment',
      'pulse.end': 'Lease ends',
      'pulse.days.one': 'in one day', 'pulse.days.many': 'in {n} days', 'pulse.ended': 'ended',
      'ring.left.one': 'day to go', 'ring.left.many': 'days to go',
      'ring.day': 'Day {d} of {total}', 'ring.before': 'Starts on {date}',
      'house.back': 'All homes', 'house.journey': 'The life of the lease', 'house.months': 'Rent, month by month',
      'feed.new': 'New since your last visit', 'feed.recent': 'Latest documents', 'feed.all': 'Open the archive',
      'arch.all': 'Everything', 'arch.missing': 'Not in the archive yet', 'arch.undated': 'Undated',
      'arch.count.one': 'one document', 'arch.count.many': '{n} documents',
      'arch.secure': 'Every document opens through a personal link that lasts 60 seconds: no attachments floating around, no permanent links.',
    },
  };
