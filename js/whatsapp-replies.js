...
Prefer a bank transfer? Say so and I'll send you the account details with the reference code to write in it.`,
  ...
  function lint() {
    ...
    if (REPLIES.length > LIMITS.total) {
      errors.push(`${REPLIES.length} risposte: l'app ne accetta ${LIMITS.total}`);
    }
  ...
  return {
    SITE, LIMITS, FAMILIES, REPLIES, GREETING, AWAY, LABELS, LINKS,
