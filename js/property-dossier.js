...
(function (root) {
  ...
  function configure(value) {
    ...
    root.document.addEventListener('click', event => {
      ...
      else if(kind==='innesto' && m.property.id===id && adapter.actions.innesto) adapter.actions.innesto(id);
    });
  }
