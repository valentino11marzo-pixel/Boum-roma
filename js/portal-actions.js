...
(function (root, factory) {
    ...
    ACTIONS.push(
        ...
        { id: 'act:firmaora', group: 'Contratti', icon: '🖊', label: 'Firma ora (in presenza o per delega)',
          keywords: 'firma firmare adesso presenza delega proprietario locatore dimentica sign magic',
          fn: 'goTo', args: ['contracts'], admin: true },
