...
(function (root) {
  ...
  var PURPOSES = [
    ...
    { key: 'segretaria.prepare', code: 'sp', label: 'Segretaria — preparazione del caso',       file: 'api/segretaria/_prepare.js',
      cloudModel: 'claude-opus-4-8', modality: 'text', localOk: true,  stakes: 'cliente',  json: true,  agreeOn: false,
      why: 'la proposta sul caso (riepilogo, seguito, bozza) passa da PROPOSTA.validate e da un tap dell\'operatore: un locale si misura sulle approvazioni' },
    ...
    { key: 'portal.ingest',     code: 'pi', label: 'Innesto — la proposta dal documento (Opus 5)', file: 'api/portal/ingest.js',
      cloudModel: 'claude-opus-5', modality: 'document', localOk: false, stakes: 'interno', json: true, agreeOn: false,
      direct: true, why: 'Innesto 3.0: Opus 5 con lo strumento `proposta`, thinking adattivo e la scala dei 400 di forma — tutto del cloud (il documento vale un contratto registrato); si conta, non si instrada' },
