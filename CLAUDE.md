...
/js/
  ...
  ai-registry.js          La Centrale AI, il registro PURO: i 25 scopi che
...
(25 voci: file, modello cloud di default, modalità testo/visione/documento/
...
Test: `node tests/ai/run.mjs` (138 check — default pinnati, confini per
