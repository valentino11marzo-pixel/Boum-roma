...
- **⚠️ `COMPANY.piva` (`17546591000`) NON supera il checksum** ufficiale a 11
  cifre — pinnato in `tests/invoice/run.mjs`. Resta in `COMPANY` per i PDF
  legacy; la fatturazione elettronica legge `billing/company`. **Va inserita
  quella vera prima di emettere il primo documento.**
