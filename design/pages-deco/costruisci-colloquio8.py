#!/usr/bin/env python3
# IL COLLOQUIO 8.0 — L'ORDINE DELLA COMPRENSIONE + LA LINGUA 2030.
...
/* ══ 8.0 · LA SALA DELLE REGOLE — l'expertise locale, verificabile ════ */
...
.regolaR::before { content:''; position:absolute; left:0; right:0;
  top:0; height:1px; background:linear-gradient(90deg,
    var(--gold), rgba(255,215,0,.05)); transform-origin:0 50%; }
@media (prefers-reduced-motion:no-preference){
  html.vivo .sala .regolaR::before { transform:scaleX(0); }
  html.vivo .sala.dentro .regolaR::before { transform:scaleX(1);
    transition:transform .85s cubic-bezier(.22,1,.36,1); }
  html.vivo .sala.dentro .regolaR:nth-child(2)::before { transition-delay:.09s; }
  html.vivo .sala.dentro .regolaR:nth-child(3)::before { transition-delay:.18s; }
  html.vivo .sala.dentro .regolaR:nth-child(4)::before { transition-delay:.27s; }
  html.vivo .sala.dentro .regolaR:nth-child(5)::before { transition-delay:.36s; }
  html.vivo .sala.dentro .regolaR:nth-child(6)::before { transition-delay:.45s; }
}
...
/* ══ 8.0 · IL BIGLIETTO CHE SI CONVALIDA ═════════════════════════════ */
.ck-pronto { position:absolute; right:clamp(16px,1.8vw,22px);
  top:-13px; z-index:4; background:#0B0B0C;
  display:inline-flex; align-items:center;
  gap:6px; padding:5px 10px; font-size:8.5px; font-weight:800;
  letter-spacing:.2em; text-transform:uppercase; color:var(--gold);
  border-radius:100px; box-shadow:inset 0 0 0 1px rgba(255,215,0,.45),
...
#ckForm.pronto .ck-barcode { opacity:.7;
...
#ckForm.pronto .ck-perf { filter:drop-shadow(0 0 6px rgba(255,215,0,.28));
  transition:filter .5s ease; }
@media (prefers-reduced-motion:reduce){
  .ck-pronto { transition:none; } }
@keyframes lamagiu {
...
SALA = """<div class="reperto-eti sale"><b>Exhibit E·2</b>
    ...
    <div class="sala sale">
      <div class="regolaR">
        ...
        <p class="rr-trappola">The 2023 Rome agreement fixes €/m² bands
          per zone. Ask the wrong rent and the contract can't be
          attested — you pay more and lose the tax break.</p>
        <p class="rr-noi">We compute the attestable band for your flat
          before you sign — <b>75 zones, the official coefficients</b> —
          and negotiate against it.</p>
      </div>
      <div class="regolaR">
        ...
        <p class="rr-noi">We push for <b>two</b>, in writing, with the
          return terms named in the contract.</p>
      </div>
      <div class="regolaR">
        ...
        <p class="rr-trappola">An unregistered lease gives you no legal
          protection <b>and no residency</b>: the paperwork chain breaks
          at the first office.</p>
      ...
      <div class="regolaR">
        ...
        <p class="rr-trappola">The fake-landlord scam dies with one
          document: the <b>visura catastale</b> names the real owner. It
          costs five euros. Almost nobody asks.</p>
        <p class="rr-noi">We pull it <b>before</b> the viewing, not after
          the deposit.</p>
      </div>
      <div class="regolaR">
        ...
        <p class="rr-trappola">The wrong contract type for your stay is
          the most common “legal” trap for foreigners — challengeable
          later, which helps nobody once you live there.</p>
        <p class="rr-noi">We pick the right form — transitional, student,
          4+4 — and prepare the <b>attestation</b> that makes it
          hold.</p>
      </div>
      <div class="regolaR">
        ...
        <p class="rr-trappola">No meter readings, no photos, no signed
          state of the flat — and the deposit argument, months later, is
          your word against theirs.</p>
        <p class="rr-noi">We sign a <b>verbale di consegna</b> on the
          spot: readings, photos, condition — emailed to both sides
          before we leave the building.</p>
      </div>
    </div>
    <p class="sala-nota sale">Rules and duties as published on our own
      pages: the <a href="/welcome-to-rome">expat guide</a> and the
      <a href="/blog-scam-bible.html">scam guide</a>. This is the part no
      platform localises for you — and the reason the hunt is run by
      someone who signs these contracts every week.</p>"""
...
A4 = atto(5, 'chi', True, False, 'The counterpart', 'You — as you should',
  ...
  """Egidi Immobiliare S.r.l. — P.IVA 17322991005, REA RM-1710623,
      ...
      WhatsApp is the person who walks your shortlist: <b>me</b>.</p>
      <p>Then there's the half no platform can copy: <b>Rome's own
      rules</b>. Which contract holds, what the negotiated bands allow,
      what must be registered and by when — the six below decide whether
      your year here is calm or expensive.""",
  '',
  '4.9<small>★</small>',
...
# il talloncino porta il segno «pronto all'imbarco»
...
<script>
/* IL BIGLIETTO CHE SI CONVALIDA — i tre campi che servono davvero
   accendono il talloncino: progresso visibile, nessun blocco (la
   validazione vera resta al submit e al server). */
(function () {
  'use strict';
  ...
  if (!n || !e || !t) return;
  function cifre(v) { return (v || '').replace(/[^0-9]/g, '').length; }
  function guarda() {
...
for ago in ('id="dubbio"', 'id="roma"', 'id="solo"', 'id="chi"',
            ...
            'class="ck-pronto"', 'class="sala sale"'):
    uno(s, ago, OUT)
